...
import static io.reactivex.rxjava3.swt.testutil.TestObserverUtil.getEmptySubscribedTestObserver;
...
public class PreconditionsTest {
	...
	public void testCheckWidgetCalledFromNonMainThread() throws InterruptedException, TimeoutException {
		...
		// 	System.err.println(	"Expected to be called on the main thread but was " + Thread.currentThread().getName());
			atomic.set(true);
		});
		thread.start();
	...
	public void testCheckWidgetWithDisposedWidget() {
		...
		testObserver.assertError(IllegalStateException.class); // The given widget is diposed
	}
	...
	public void testCheckWidgetWithNullWidget() {
		...
		testObserver.assertError(NullPointerException.class); // The given widget was null
